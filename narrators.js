...
function update(source) {
  ...
  var nodes = tree.nodes(root).reverse(), //returns nodes of tree before update
      links = tree.links(nodes);         //returns links of tree before update

  // Normalize for fixed-depth.
  nodes.forEach(function(d) { d.y = d.depth * 180; }); //creates a 180 pixel gap between each layer of the tree
